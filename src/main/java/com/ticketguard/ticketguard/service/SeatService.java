...
public class SeatService {
    ...
    public void lockSeat(Long scheduleId, String seatNumber, String userPhone) {
        ...
        messagingTemplate.convertAndSend("/topic/seat-updates/" + scheduleId,
                Map.of("seatNumber", seatNumber, "status", "LOCKED", "userPhone", userPhone));
    }
